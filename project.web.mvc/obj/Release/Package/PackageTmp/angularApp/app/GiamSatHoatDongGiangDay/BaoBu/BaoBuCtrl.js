...
app.controller('BaoBuPhanPhongModalCtrl', function ($scope, $uibModalInstance, objs, BaoBuSvc, $filter) {
    ...
    $scope.DanhSachPhong = function (objs) {
        ...
        //Load data
        BaoBuSvc.showloading();
        BaoBuSvc.GetApiCallCustomLink(UrlDomainAPI + "api/ThongTinCaiDatChung/GET_TinhTrangPhong_KiemTraListPhongRanh?coso=" + coso + "&lau=" + lau + "&thoigian=" + objs.thoigian + "&tietbatdau=" + objs.tietbatdau + "&sotiet=" + objs.sotiet + "&phongid=" + objs.phongid)
        .then(function (response) {
