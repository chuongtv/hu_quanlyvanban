    ...
    $scope.XacNhanCapPhong = function (user) {
        ...
        BaoBuTruocSvc.PostApiCall(listSave, BaoBuTruocSvc.API_PostXacNhanCapPhong)  //goi api get du lieu
            .then(function (response) {
                ...
                .then(function (response) {
                    alert("Phiếu báo bù trước đã được cấp phòng thành công");
...
app.controller('BaoBuTruocPhanPhongModalCtrl', function ($scope, $uibModalInstance, objs, BaoBuTruocSvc, $filter) {
    ...
    $scope.DanhSachPhong = function (objs) {
        ...
        //Load data
        BaoBuTruocSvc.showloading();
        BaoBuTruocSvc.GetApiCallCustomLink(UrlDomainAPI + "api/ThongTinCaiDatChung/GET_TinhTrangPhong_GetListPhongTrong?coso=" + coso + "&lau=" + lau + "&thoigian=" + objs.thoigian + "&tietbatdau=" + objs.tietbatdau + "&sotiet=" + objs.sotiet + "&phongid=" + objs.phongid + "&tinhchat=" + objs.tinhchat.ValueString)
        .then(function (response) {
            ...
            $scope.filterto.lau = null;
                ...
                .then(function (response) {
                   ...
                   for (var i = 0; i < ListLau.length; i++) {
                    ...
                    BaoBuTruocSvc.GetApiCallCustomLink(UrlDomainAPI + "api/ThongTinCaiDatChung/GET_TinhTrangPhong_GetListTinhChatPhong")
                    .then(function (response) {
