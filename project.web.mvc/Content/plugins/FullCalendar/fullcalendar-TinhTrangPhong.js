    ...
    */
    ...
    DayGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            // Only display a timed events time if it is the starting segment Chuong@
            if (seg.isStart) {
    ...
    TimeGrid.mixin({
        ...
        // Renders the HTML for a single event segment's default rendering chuong@
        fgSegHtml: function (seg, disableResizing) {
            var view = this.view;
            var event = seg.event;
            var isDraggable = view.isEventDraggable(event);
            ...
            //				+*/ 
            //			(event.title ?
            //				'<div class="fc-title"> MH: ' +
            //					htmlEscape(event.title) +
            //				'</div>':''
            //				)+
            //			(event.phonghoc ?
            //				'<div class="fc-title"> PH: ' +
            //					htmlEscape(event.phonghoc) +
            //				'</div>':''
            //				)+
            //		'</div>' +
            //		'<div class="fc-bg"/>' +
            ...
            //                        '<b>Mã môn</b>:' + htmlEscape(event.title)<br/> +
            //                        '<b>Tên môn</b>:' + htmlEscape(event.phonghoc) + '"></span>' +
            //+ '<span><img class="callout" src="/Content/plugins/FullCalendar/tootip/callout.gif" /><strong>Most Light-weight Tooltip</strong><br />This is the easy-to-use Tooltip driven purely by CSS.</span>' +

            return '<a style="background-color:'+event.colorbg+';" class="' + classes.join(' ') + ' "' +
                (event.url ?
                ...
                '>' +
                    '<div class="fc-content">' +
                        /*(timeText ?
                            ...
                            +*/
                        (event.Loai ?
                            '<div class="fc-title"> Loại: ' +
                                htmlEscape(event.Loai) +
                            '</div>' : ''
                            ) +
                        (event.phonghoc ?
                            '<div class="fc-title"> PH: ' +
                        ...
                        (event.lop ?
                            '<div class="fc-title"> LH: ' +
                                htmlEscape(event.lop) +
                            '</div>' : ''
                            ) +
						(event.TietBatDau ?
                            '<div class="fc-title"> TBĐ: ' +
                                htmlEscape(event.TietBatDau) +
                            '</div>' : ''
                            ) +
						(event.TietKetThuc ?
                            '<div class="fc-title"> TKT: ' +
                                htmlEscape(event.TietKetThuc) +
                            '</div>' : ''
                            ) +
						(event.LinkChiTiet ?
                            '<div class="fc-title"> ' +
                                htmlEscape('<a href="/' + event.LinkChiTiet + '" target="_blank">Xem chi tiết</a>') +
                            '</div>' : ''
                            ) +	
                    '</div>' +
                    '<div class="fc-bg"/>' +
